...
# 启用工具学习
agent.enable_tool_learning()

# 运行任务
result = agent.run("帮我分析这个项目的代码结构")
```
...
- Claws概念论文: https://arxiv.org/claws-intro
- Agent评估基准: https://github.com/agentbench/agentbench
