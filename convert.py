...
with open('/Users/gordon/clawd/research-reports/enterprise-llm-consolidation-report-2026-05-21.md', 'r') as f:
    md = f.read()
...
<head>
    ...
    <title>LLM企业落地：从碎片化到整合——2026企业AI架构下一步 | Research Notes</title>
    <style>
...
<body>
    ...
    <main class="main">
        <h1>LLM企业落地：从碎片化到整合——2026企业AI架构下一步</h1>
        <div class="report-meta">
            <strong>📄 报告日期</strong>：2026年5月21日<br>
            <strong>📂 报告类型</strong>：深度行业分析<br>
            <p>覆盖范围：全球企业LLM部署现状、碎片化根因、整合战略、选型框架</p>
        </div>
        {content}
    </main>
    <div class="footer">
...
with open('/Users/gordon/clawd/research-reports/enterprise-llm-consolidation-report-2026-05-21.html', 'w') as f:
    f.write(html)
