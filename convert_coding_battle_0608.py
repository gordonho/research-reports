...
with open('/Users/gordon/clawd/research-reports/2026-06-08-ai-coding-models-battle-2026.md', 'r') as f:
    md = f.read()
...
<head>
    ...
    <title>AI编程模型大战深度报告：谁能取代程序员？ | Research Notes</title>
    <style>
...
<body>
    ...
    <main class="main">
        <h1>AI编程模型大战深度报告：谁能取代程序员？</h1>
        <div class="report-meta">
            <strong>📄 报告日期</strong>：2026年6月8日<br>
            <strong>📂 报告类型</strong>：深度行业分析<br>
            <p>覆盖范围：GitHub Copilot vs Claude Code vs GPT-5.3 Codex vs Gemini CLI，SWE-bench基准测试，企业选型建议</p>
        </div>
        {content}
    </main>
    <div class="footer">
...
with open('/Users/gordon/clawd/research-reports/2026-06-08-ai-coding-models-battle-2026.html', 'w') as f:
    f.write(html)
