...
with open('/Users/gordon/clawd/research-reports/2026-05-29-google-io-2026-full-analysis.md', 'r') as f:
    md = f.read()
...
<head>
    ...
    <title>Google I/O 2026 全解读：Gemini Omni、3.5与搜索框25年来最大变革 | Research Notes</title>
    <style>
...
<body>
    ...
    <main class="main">
        <h1>Google I/O 2026 全解读：Gemini Omni、Gemini 3.5 与搜索框25年来最大变革</h1>
        <div class="report-meta">
            <strong>📄 报告日期</strong>：2026年5月29日<br>
            <strong>📂 报告类型</strong>：深度行业分析<br>
            <p>覆盖范围：Gemini Omni多模态视频、搜索框AI重构、Android XR智能眼镜、Gemini Spark</p>
        </div>
        {content}
    </main>
    <div class="footer">
...
with open('/Users/gordon/clawd/research-reports/2026-05-29-google-io-2026-full-analysis.html', 'w') as f:
    f.write(html)
